    ...
    return (
        <footer className="footer">
            <section className="contet-section">
                ...
                <img alt="icon-Facebook" className="icons-social" src="https://img.icons8.com/color/48/000000/facebook.png" />
                <img alt="icon-Instagram" className="icons-social" src="https://img.icons8.com/color/48/000000/instagram-new--v2.png" />
                <img alt="icon-Discord" className="icons-social" src="https://img.icons8.com/color/48/000000/discord--v2.png" />
            </section>
